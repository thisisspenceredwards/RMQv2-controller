...
WIND_SPEED_MAXIMUM_FOR_LOWER_LOCK_THRESHOLD = 15
...
BLIND_THREAD_SLEEP_TIME = 0.05
BLIND_MOVEMENT_COEFFICIENT = 0.05
...
WIND_SPEED_AUTO_RAISE_THRESHOLD_KEY = "WIND_SPEED_AUTO_RAISE_THRESHOLD"
WIND_SPEED_LOWER_LOCK_THRESHOLD_KEY = "WIND_SPEED_LOWER_LOCK_THRESHOLD"
MAC_ADDRESS_KEY = "MAC_ADDRESS"
CONTROLLER_TIME = "CONTROLLER_TIME"

#used with RoomSettingsManager
UPDATE_ROOM_ID = "UPDATE_ROOM_ID"
UPDATE_WIND_SPEED_AUTO_RAISE_THRESHOLD = "UPDATE_WIND_SPEED_AUTO_RAISE_THRESHOLD"
UPDATE_WIND_SPEED_LOWER_LOCK_THRESHOLD = "UPDATE_WIND_SPEED_LOWER_LOCK_THRESHOLD"
...
RELAY_MAPPING_DICT = {
                         ...
                         LIGHT_FOUR_KEY: 4,
                         BLIND_ONE_KEY: [5, 6, 7],
                         BLIND_TWO_KEY: [8, 9, 10],
                         BLIND_THREE_KEY: [11, 12, 13],
                         BLIND_FOUR_KEY: [14, 15, 16],
                         BLIND_FIVE_KEY: [17, 18, 19],
                         BLIND_SIX_KEY: [20, 21, 22],
                         BLIND_SEVEN_KEY: [23, 24, 25],
                         BLIND_EIGHT_KEY: [26, 27, 28],
                         RECEPTACLE_ONE_KEY: 29,
                         RECEPTACLE_TWO_KEY: 30,
                         RECEPTACLE_THREE_KEY: 31,
                         RECEPTACLE_FOUR_KEY: 32,
                         RECEPTACLE_FIVE_KEY: 33,
                         RECEPTACLE_SIX_KEY: 34,
                         RECEPTACLE_SEVEN_KEY: 34,
                         RECEPTACLE_EIGHT_KEY: 36,
                     }
